...
public class AddProcess implements CommandExecutor {
    @Override
    public void execute(List<Group> listOfGroups, String[] params, List<MyProcess> listOfProcesses) {
        ...
        foundGroup.addProcess(foundProcess);

        System.out.println("Process \"" + processPid + "\" was added to group \"" + groupName + "\"");
    }
}
